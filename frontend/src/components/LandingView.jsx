  ...
  return (
    <AuroraBackground className="relative py-8 sm:py-14 font-sans bg-transparent">
      ...
      <section className="text-center max-w-5xl mx-auto pt-4 sm:pt-10 pb-16 sm:pb-24 px-4 relative z-10">
        ...
        <div className="inline-flex items-center space-x-3 px-5 py-2.5 rounded-full theme-glass-pill text-emerald-400 text-xs font-semibold backdrop-blur-3xl mb-8 transform hover:scale-105 transition-all duration-300 cursor-default shadow-[0_0_25px_rgba(16,185,129,0.25)]">
          ...
          <span className="font-display tracking-wide text-white">
            Deterministic AST Engine <span className="text-emerald-400 font-bold">&bull;</span> Nvidia Nemotron 550B Audit
          </span>
        </div>
        ...
        <h1 className="text-4xl sm:text-6xl lg:text-7xl font-extrabold font-display text-white tracking-tight leading-[1.12] mb-6 sm:mb-8">
          ...
          <CanvasText
            ...
            colors={[
              "rgba(16, 185, 129, 1)",      // Cyber Emerald #10B981
              "rgba(52, 211, 153, 0.95)",   // Mint #34D399
              "rgba(255, 255, 255, 0.95)",  // Pure White
              "rgba(20, 184, 166, 0.9)",    // Teal #14B8A6
              "rgba(16, 185, 129, 0.85)",   // Cyber Emerald
              "rgba(52, 211, 153, 0.8)",    // Mint
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
          <button
            ...
            className="w-full sm:w-auto px-9 py-4 rounded-2xl bg-gradient-to-r from-emerald-500 via-teal-500 to-emerald-600 text-white font-extrabold text-base flex items-center justify-center space-x-3 shadow-[0_0_35px_rgba(16,185,129,0.45)] hover:shadow-[0_0_50px_rgba(16,185,129,0.7)] border border-white/20 transition-all duration-300 transform hover:scale-105 active:scale-95 cursor-pointer font-display tracking-tight"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="w-full sm:w-auto px-8 py-4 rounded-2xl theme-glass-pill hover:bg-white/10 text-slate-200 hover:text-white font-semibold text-base transition-all duration-300 flex items-center justify-center space-x-2.5 shadow-lg backdrop-blur-3xl font-display hover:border-emerald-500/50"
          >
        ...
        <div className="mb-14 rounded-3xl theme-glass p-3 sm:p-5 shadow-[0_25px_60px_rgba(2,11,8,0.8)] text-left relative overflow-hidden group">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3.5 border-b border-emerald-500/20">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span className="text-[10px] font-mono font-bold bg-teal-500/15 text-teal-300 px-2.5 py-1 rounded-full border border-teal-500/30">
                0 BYTECODE EXEC
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4 font-mono text-xs">
            {/* Telemetry Stat 1 */}
            <div className="p-3.5 rounded-2xl bg-[#020B08]/80 border border-emerald-500/20 space-y-1.5">
            ...
            {/* Telemetry Stat 3 */}
            <div className="p-3.5 rounded-2xl bg-[#020B08]/80 border border-emerald-500/20 space-y-1.5">
              <div className="text-[11px] text-teal-400 font-bold flex items-center justify-between">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-4xl mx-auto text-left">
          <div className="p-5 rounded-3xl theme-glass-card shadow-xl hover:border-emerald-500/50 transition-all duration-300 group transform hover:-translate-y-1">
      ...
      <section className="max-w-4xl mx-auto py-8 sm:py-16 px-4 relative z-10 space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 px-2">
          ...
          <span className="w-fit text-[11px] font-mono text-emerald-400 bg-emerald-500/15 px-3 py-1 rounded-full border border-emerald-500/30 backdrop-blur-xl shadow-sm">
            Realtime AST Diff
          </span>
        </div>

        {/* Frosted Glass Window */}
        <div className="rounded-[32px] theme-glass p-1 shadow-[0_30px_70px_rgba(2,11,8,0.8)] overflow-hidden">
          {/* Window Header */}
          <div className="flex items-center justify-between px-5 py-4 bg-white/[0.03] border-b border-emerald-500/20">
            <div className="flex items-center space-x-2.5">
            ...
            <div className="flex items-center p-1 bg-[#020B08]/80 border border-emerald-500/20 rounded-xl backdrop-blur-xl">
          ...
          {/* Explanation Footer */}
          <div className="px-5 py-4 bg-white/[0.02] border-t border-emerald-500/20 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 text-xs text-slate-300">
            <span className="flex items-center space-x-2">
              <Sparkles className="w-3.5 h-3.5 text-emerald-400 flex-shrink-0" />
              <span>{codeDemos[activeCodeTab].explanation}</span>
            </span>
            <span className="text-emerald-400 font-mono font-bold">0 Hallucination</span>
          </div>
        </div>
      </section>
        ...
        <ul className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-fr">
          ...
          <li className="md:col-span-4 list-none">
            <div className="relative h-full rounded-[30px] theme-glass p-2 sm:p-3 group transition-all duration-300">
              ...
              <div className="relative flex h-full flex-col justify-between gap-5 rounded-[22px] p-6 bg-[#020B08]/80 border border-emerald-500/20 backdrop-blur-2xl">
                <div className="space-y-3.5">
                  <div className="w-fit rounded-2xl border border-emerald-500/30 bg-emerald-500/15 p-3 text-emerald-400 shadow-inner">
                ...
                <div className="flex flex-wrap gap-1.5 pt-3 border-t border-emerald-500/20 text-[10px] font-mono">
                  <span className="px-2.5 py-0.5 rounded-full bg-emerald-500/15 text-emerald-400 border border-emerald-500/30">SQLi Shield</span>
                  <span className="px-2.5 py-0.5 rounded-full bg-rose-500/15 text-rose-300 border border-rose-500/30">RCE Blocked</span>
                  <span className="px-2.5 py-0.5 rounded-full bg-teal-500/25 text-teal-300 border border-teal-500/40">XSS Sanitizer</span>
          ...
          <li className="md:col-span-4 md:row-span-2 list-none">
            <div className="relative h-full rounded-[30px] theme-glass p-2 sm:p-3 group transition-all duration-300">
              ...
              <div className="relative flex h-full flex-col justify-between gap-5 rounded-[22px] p-6 bg-[#020B08]/80 border border-emerald-500/20 backdrop-blur-2xl">
                ...
                <div className="my-auto rounded-2xl bg-black/60 border border-emerald-500/20 p-4 font-mono text-[11px] space-y-3 shadow-inner backdrop-blur-2xl">
                  <div className="flex items-center justify-between pb-2 border-b border-emerald-500/20 text-[10px] text-slate-500">
          ...
          <li className="md:col-span-4 list-none">
            <div className="relative h-full rounded-[30px] theme-glass p-2 sm:p-3 group transition-all duration-300">
              ...
              <div className="relative flex h-full flex-col justify-between gap-5 rounded-[22px] p-6 bg-[#020B08]/80 border border-emerald-500/20 backdrop-blur-2xl">
                ...
                <div className="flex flex-wrap gap-1.5 pt-3 border-t border-emerald-500/20 text-[10px] font-mono">
                  <span className="px-2.5 py-0.5 rounded-full bg-emerald-500/20 text-emerald-400 border border-emerald-500/30">Nemotron 550B</span>
                  <span className="px-2.5 py-0.5 rounded-full bg-teal-500/20 text-teal-300 border border-teal-500/30">Inkling Small</span>
              ...
              <div className="relative flex h-full flex-col justify-between gap-5 rounded-[22px] p-6 bg-[#020B08]/80 border border-emerald-500/20 backdrop-blur-2xl">
                ...
                <div className="space-y-2.5 pt-3 border-t border-emerald-500/20">
                  ...
                  <div className="h-2.5 w-full bg-black/60 rounded-full overflow-hidden flex border border-white/10 p-0.5">
                    <div className="bg-emerald-500 h-full rounded-full w-[60%]" title="Security 60%" />
                    <div className="bg-teal-500 h-full rounded-full w-[25%]" title="Quality 25%" />
                    <div className="bg-emerald-800 h-full rounded-full w-[15%]" title="Operations 15%" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <li className="md:col-span-4 list-none">
            <div className="relative h-full rounded-[30px] theme-glass p-2 sm:p-3 group transition-all duration-300">
              ...
              <div className="relative flex h-full flex-col justify-between gap-5 rounded-[22px] p-6 bg-[#020B08]/80 border border-emerald-500/20 backdrop-blur-2xl">
                ...
                <div className="flex items-center justify-between pt-3 border-t border-emerald-500/20 text-[10px] font-mono text-slate-400">
                  <span className="flex items-center space-x-1.5">
                    <CheckCircle2 className="w-3.5 h-3.5 text-emerald-400" />
      ...
      <section className="max-w-5xl mx-auto py-8 sm:py-16 px-4 relative z-10 space-y-10">
        <div className="text-center space-y-3">
          <div className="inline-flex items-center space-x-2 text-xs font-mono text-emerald-400 font-bold uppercase tracking-wider theme-glass-pill px-4 py-1.5 rounded-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 pt-2">
          {/* Stage 1 */}
          <div className="p-6 rounded-[28px] theme-glass-card hover:border-emerald-500/50 transition-all duration-300 group shadow-xl">
            <div className="w-10 h-10 rounded-2xl bg-emerald-500/15 border border-emerald-500/30 flex items-center justify-center text-emerald-400 font-bold font-mono text-xs mb-4">
              01
            </div>
          ...
          {/* Stage 2 */}
          <div className="p-6 rounded-[28px] theme-glass-card hover:border-emerald-500/50 transition-all duration-300 group shadow-xl">
            <div className="w-10 h-10 rounded-2xl bg-teal-500/20 border border-teal-500/30 flex items-center justify-center text-teal-300 font-bold font-mono text-xs mb-4">
              02
            </div>
      ...
      <section className="max-w-4xl mx-auto py-8 sm:py-16 px-4 relative z-10">
        <div className="relative rounded-[36px] theme-glass p-8 sm:p-14 text-center space-y-6 overflow-hidden shadow-[0_30px_80px_rgba(2,11,8,0.8)]">
          <div className="absolute -top-24 left-1/2 -translate-x-1/2 w-[500px] h-60 bg-emerald-500/20 rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="pt-3 flex flex-col sm:flex-row items-center justify-center gap-4">
            <button
              onClick={onStartAnalysis}
              className="w-full sm:w-auto px-9 py-4 rounded-2xl bg-gradient-to-r from-emerald-500 via-teal-500 to-emerald-600 text-white font-extrabold text-sm flex items-center justify-center space-x-2.5 shadow-[0_15px_35px_rgba(16,185,129,0.45)] hover:shadow-[0_20px_45px_rgba(16,185,129,0.6)] border border-white/20 transition-all duration-300 cursor-pointer font-display transform hover:scale-105 active:scale-95"
            >
