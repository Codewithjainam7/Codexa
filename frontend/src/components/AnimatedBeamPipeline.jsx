    ...
    <div className="flex flex-col items-center space-y-1.5 z-10">
      <div
        ...
        className={cn(
          ...
          active 
            ? "border-emerald-400 bg-[#020B08] text-emerald-300 shadow-[0_0_25px_rgba(16,185,129,0.4)] scale-110"
            : completed
            ? "border-emerald-500/60 bg-[#020B08]/90 text-emerald-400 shadow-[0_0_15px_rgba(16,185,129,0.15)]"
            : "border-slate-800 bg-[#020B08]/60 text-slate-500 hover:border-slate-700",
          className
        )}
      >
        {children}
        {completed && (
          <div className="absolute -top-1 -right-1 w-4 h-4 bg-emerald-400 rounded-full flex items-center justify-center text-slate-950">
...
export function AnimatedBeamPipeline({ currentStage = "INGESTION", sourceIdentifier = "Repository" }) {
  ...
  return (
    <div
      ref={containerRef}
      className="relative flex w-full max-w-3xl mx-auto items-center justify-between p-6 sm:p-10 rounded-3xl bg-[#020B08]/90 border border-emerald-500/20 shadow-2xl overflow-hidden backdrop-blur-xl"
    >
      ...
      <div className="flex flex-col items-center justify-center z-10 px-2 sm:px-4">
        <div className="relative">
          ...
          <div className="absolute -inset-6 rounded-full border border-emerald-500/30 animate-spin" style={{ animationDuration: '15s' }} />

          <div
            ref={centerHubRef}
            className="relative flex size-20 sm:size-24 items-center justify-center rounded-3xl border-2 border-emerald-400 bg-gradient-to-tr from-slate-900 via-[#020B08] to-emerald-950/60 p-4 shadow-[0_0_35px_rgba(16,185,129,0.4)] text-emerald-300 transform transition-transform hover:scale-105"
          >
