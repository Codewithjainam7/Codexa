        ...
        <div className="bg-slate-900/40 border border-slate-800 rounded-2xl p-8 space-y-6">
          <form onSubmit={handleGithubSubmit} className="space-y-4">
            ...
            <button
              ...
              className="w-full py-3 rounded-xl bg-emerald-500 hover:bg-emerald-400 disabled:opacity-50 text-slate-950 text-sm font-bold flex items-center justify-center space-x-2 shadow-lg shadow-emerald-500/20 transition-all cursor-pointer"
            >
              {isSubmitting ? (
                <>
            ...
            {file && (
              <div className="flex items-center gap-3 pt-2">
                ...
                <button
                  ...
                  disabled={isSubmitting}
                  className="px-6 py-2 rounded-lg bg-emerald-500 hover:bg-emerald-400 disabled:opacity-50 text-slate-950 text-xs font-bold flex items-center space-x-2 shadow-md shadow-emerald-500/20 transition-all cursor-pointer"
                >
                  {isSubmitting ? (
                    <>
                      <Loader2 className="w-4 h-4 animate-spin" />
