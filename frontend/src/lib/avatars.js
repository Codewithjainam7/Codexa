import { Bot, Atom, Terminal, Brain, Shield, Bug, Binary, Rocket } from 'lucide-react';
...
export const TECH_AVATARS = [
  ...
  { id: 'daemon', name: 'Glitch Daemon', role: 'Bug Hunter', icon: Bug, color: 'from-purple-500 to-indigo-600', text: 'text-purple-400', bg: 'bg-purple-500/15', border: 'border-purple-500/30' },
